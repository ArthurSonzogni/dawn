...
tint_ExternalTextureParams v_49(uint start_byte_offset) {
  ...
  tint_GammaTransferParams v_69 = v_53;
  tint_GammaTransferParams v_70 = v_54;
  tint_ExternalTextureParams v_71 = {v_50, v_51, v_52, v_69, v_70, v_55, v_56, v_57, v_59, v_61, v_63, v_65, v_67, asfloat(((((((264u + start_byte_offset) % 16u) / 4u) == 2u)) ? (v_68.zw) : (v_68.xy)))};
  return v_71;
}

[numthreads(1, 1, 1)]
void main() {
  Texture2D<float4> v_72 = t_plane0;
  Texture2D<float4> v_73 = t_plane1;
  tint_ExternalTextureParams v_74 = v_49(0u);
  tint_ExternalTextureParams v_75 = v_74;
  float4 red = tint_TextureLoadExternal(v_72, v_73, v_75, uint2((10).xx));
  outImage[(0).xx] = red;
  Texture2D<float4> v_76 = t_plane0;
  Texture2D<float4> v_77 = t_plane1;
  tint_ExternalTextureParams v_78 = v_49(0u);
  tint_ExternalTextureParams v_79 = v_78;
  float4 green = tint_TextureLoadExternal(v_76, v_77, v_79, uint2(int2(70, 118)));
