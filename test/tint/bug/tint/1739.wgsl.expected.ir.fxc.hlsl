...
[numthreads(1, 1, 1)]
void main() {
  tint_ExternalTextureParams v_72 = v_49(0u);
  tint_ExternalTextureParams v_73 = v_72;
  ...
  float4 green = tint_TextureLoadExternal(t_plane0, t_plane1, v_75, uint2(int2(int(70), int(118))));
